...
class TestRandomScaledBetaProb(TestCase):
    ...
    def test_missed_range(self):
        self.assertRaises(AssertionError, lambda: rg.ScaledBetaProb(lower=0.0, upper=1.0, middle=2.0))
